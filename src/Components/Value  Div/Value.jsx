...
const Value = () => {
  return (
    <div className='mb-[4rem] mt-[6rem]'>
      <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[400px block'>The principles that we are willing to die for. </h1>
      <div className='grid gap-[10rem] grid-cols-3 items-center '>
        ...
        <div className='singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]'>
          ...
          <p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
            Things made beautiful simple are at the heart of everything we do.
          </p>
    ...
    <div>
      ...
      <button className='border-[2px] rounded-[10px] py-[4px] px-[50px] text-[18px] font-semibold text-blurColor hover:bg-white border-blueColor'>
        Get Started
      </button>
    </div>
    </div>
